...
namespace RxnCreate
{
    ...
    public class UnitTesterCluster : ElasticQueue<StartUnitTest, UnitTestResult>, IRxnProcessor<StartUnitTest>,
        IManageResources
    {
    ...
    public class UnitTestAgent : IContainerPostBuildService, IDisposable
    {
        ...
        public static IObservable<IRxnAppContext> RunTestAgentReactor(string url = "http://192.168.1.2:888/",
            params string[] args)
        {
