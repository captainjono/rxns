...
gulp.task('js', ['clean'], function() {
    ...
    var templateStream = gulp.src(['!node_modules/**', '!index.html', '!_SpecRunner.html', '!.grunt/**', '!dist/**', '!bower_components/**', '!protractor_conf.js', '!shared_components/**', '**/*.html'])
...
gulp.task('jshint', function(){
    gulp.src(['!node_modules/**', '!.grunt/**', '!dist/**', '!bower_components/**', '!shared_components/**', '!protractor_conf.js', '**/*.js'])
        .pipe(jshint())
