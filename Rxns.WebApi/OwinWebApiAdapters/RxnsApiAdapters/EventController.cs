...
namespace Rxns.WebApi.OwinWebApiAdapters.RxnsApiAdapters
{
    [Route("events")]
    //[Authorize]
    public class EventController : ReportsStatusApiController
    {
        ...
        [Route("publish")]
        [HttpPost]
        public IHttpActionResult Publish(HttpRequestMessage cmd)
        {
            try
            {
                var eventCount = 0;
