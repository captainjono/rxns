...
namespace Rxns.DDD.CQRS
{
    ...
    public interface IDomainCommandHandler<T, TR> : IAsyncRequestHandler<T, DomainCommandResult<TR>>
        where T : IDomainCommand<TR>, IAsyncRequest<DomainCommandResult<TR>>
    {
