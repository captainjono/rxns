...
namespace Rxns
{
    ...
    /// rxn managers
    /// </summary>
    public class EventToRouteCfgBuilder
    {
        /// <summary>
        ...
        /// <returns></returns>
        public IRxnTargetCfg OnReactionTo<T>(Func<T, bool> when = null) where T : class
        {
            when = when ?? (_ => true);
        ...
        /// <param name="when"></param>
        /// <returns></returns>
        public IRxnTargetCfg OnReactionTo(Type typeOfEvent, Func<object, bool> when = null)
        {
            when = when ?? (_ => true);
        ...
        /// </summary>
        /// <returns></returns>
        public IRxnTargetCfg OnReaction()
        {
