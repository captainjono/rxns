...
namespace Rxns.Reliability
{
    ...
    /// 
    /// This namespace is a modified version of Polly
    /// </summary>
    public class Policy : IReliabilityPolicy
    {
        ...
        /// <typeparam name="TException">The type of the exception to handle.</typeparam>
        /// <returns>The PolicyBuilder instance.</returns>
        public static PolicyBuilder ThrowOn<TException>() where TException : Exception
        {
            ExceptionPredicate predicate = exception => !(exception is TException);
