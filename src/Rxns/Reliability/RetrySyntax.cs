...
namespace Rxns.Reliability
{
    ...
    public static class RetrySyntax
    {
        ...
        {
            Action<Exception, long> doNothing = (_, __) => { };
        ...
        /// <returns>The policy instance.</returns>
        /// <exception cref="System.ArgumentNullException">onRetry</exception>
        public static Policy RetryForever(this PolicyBuilder policyBuilder, Action<Exception, long> onRetry)
        {
            if (onRetry == null) throw new ArgumentNullException("onRetry");
        ...
        /// <returns>The policy instance.</returns>
        /// <exception cref="System.ArgumentNullException">onRetry</exception>
        public static ContextualPolicy RetryForever(this PolicyBuilder policyBuilder, Action<Exception, long, Context> onRetry)
        {
            if (onRetry == null) throw new ArgumentNullException("onRetry");
